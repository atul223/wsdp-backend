const service = require('./ehsInspection.service');
...
async function create(req, res, next) {
  try {
    ...
    return created(res, { data, message: 'EHS inspection recorded successfully' });
  } catch (err) {
    next(err);
  }
}
...
async function fullUpdate(req, res, next) {
  try {
    ...
    return success(res, { data, message: 'EHS inspection updated successfully' });
  } catch (err) {
    next(err);
  }
}
...
async function updateChecklistItem(req, res, next) {
  try {
    ...
    return success(res, { data, message: 'Checklist item updated successfully' });
  } catch (err) {
    next(err);
  }
}

module.exports = { list, getOne, create, fullUpdate, partialUpdate, remove, updateChecklistItem };
