const service = require('./ncr.service');
...
async function create(req, res, next) {
  try {
    ...
    return created(res, { data, message: 'Non-conformity record created successfully' });
  } catch (err) {
    next(err);
  }
}
...
async function update(req, res, next) {
  try {
    ...
    return success(res, { data, message: 'Non-conformity record updated successfully' });
  } catch (err) {
    next(err);
  }
}
