const service = require('./workPackage.service');
...
async function create(req, res, next) {
  try {
    ...
    return created(res, { data, message: 'Work package created successfully' });
  } catch (err) {
    next(err);
  }
}
...
async function fullUpdate(req, res, next) {
  try {
    ...
    return success(res, { data, message: 'Work package updated successfully' });
  } catch (err) {
    next(err);
  }
}
