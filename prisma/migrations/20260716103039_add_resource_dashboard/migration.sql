...
-- AddForeignKey
ALTER TABLE "allocations" ADD CONSTRAINT "allocations_work_package_id_fkey" FOREIGN KEY ("work_package_id") REFERENCES "work_packages"("id") ON DELETE SET NULL ON UPDATE CASCADE;
